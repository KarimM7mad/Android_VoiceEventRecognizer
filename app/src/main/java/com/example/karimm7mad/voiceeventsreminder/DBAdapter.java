...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_TIMESTAMP};

    // [TO_DO_A5]
    // DB info: db name and table name.
    public static final String DATABASE_NAME = "voiceEventReminder";
    ...
    public long insertRow(String name, String timestamp) {
        // [TO_DO_A8]
    ...
    public boolean updateRow(long rowId, String name, int timestamp) {
        String where = KEY_ROWID + "=" + rowId;
